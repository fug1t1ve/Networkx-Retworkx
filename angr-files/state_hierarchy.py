...
class StateHierarchy(object):
    def __init__(self):
        ...
        # The New Order
        self._graph = retworkx.PyDiGraph()
    ...
    def __getstate__(self):
        histories = [ h() for h in retworkx.digraph_dfs_edges(self._graph) ]
        return (histories,)
    ...
    def all_successors(self, h):
        nodes = list(retworkx.digraph_dfs_edges(self._graph, h))[:-1]
        nodes.reverse()
        return nodes
    ...
    def _prune_subtree(self, h):
        ...
        all_children = list(retworkx.digraph_dfs_edges(self._graph, h))
    ...
    def most_mergeable(self, states):
        ...
        for n in retworkx.digraph_dfs_edges(self._graph):
